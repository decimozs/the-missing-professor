...
function RouteComponent() {
  ...
  const handleSubmitDecryption = () => {
    console.log(
      "Comparing:",
      decodedMessage.toUpperCase(),
      "vs",
      correctDecoded.toUpperCase()
    );
    if (
      decodedMessage.toUpperCase().trim() ===
      correctDecoded.toUpperCase().trim()
    ) {
      ...
      addClue({
        ...
        content:
          "To wake up E.R speak its first poem. Not a greeting but a riddle.",
